...
test_total_count_mean_words_div <- left_join(test_total_count_words, test_lex_diversity_per_genre_div)
...
#6. Train the model
svm_Linear_div <- train(genre ~ total_words + total_mean_lex, data = training_count_words_div, method = "svmLinear",
                 trControl=trctrl,
